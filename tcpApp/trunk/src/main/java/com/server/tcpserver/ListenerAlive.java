...
//구현
public class ListenerAlive extends WebSocketEventListener {

    public ConnectUser connectUser;
    public ListenerAlive() throws Exception {

        WebSocketEventHandler.addListener(this);
        connectUser = ConnectUser.getInstance();
        Thread t = new Logout(this);
        t.start();
    }
    String id = "";
    String time="";
    ...
    public String onEvent1(String event, ChannelHandlerContext ctx) {
        ...
        try {
            ...
            if (opcode.equals("02003")) {
                ...
                db.Alivetime(event);
                sendMsg=Message.makeResposeMessage_03001("0",list);
            }else {
                sendMsg = event;
            }
